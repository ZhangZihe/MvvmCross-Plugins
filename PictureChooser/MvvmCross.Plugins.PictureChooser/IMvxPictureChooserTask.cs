...
namespace MvvmCross.Plugins.PictureChooser
{
    public interface IMvxPictureChooserTask
    {
        ...
        void ChoosePictureFromLibrary(int maxPixelDimension, int percentQuality, bool allowsEditing, Action<Stream, string> pictureAvailable,
        ...
        /// <param name="assumeCancelled">Action to invoke on cancellation</param>
        void ChoosePictureFromLibrary(int maxPixelDimension, int percentQuality, bool allowsEditing, Action<Stream> pictureAvailable,
                                      Action assumeCancelled);
        ...
        /// <param name="pictureAvailable"> Action to invoke when picture is available.</param>
        /// <param name="assumeCancelled">Action to invoke on cancellation.</param>
        void TakePicture(int maxPixelDimension, int percentQuality, bool allowsEditing, Action<Stream> pictureAvailable,
                         Action assumeCancelled);
